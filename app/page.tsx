...
const slides = [
  ...
  { id: 6, title: "Our Solution", name: "Our Solution – BugChase" },
  ...
  return (
    <div className="relative min-h-screen w-full" style={{ backgroundColor: '#000000' }}>
      ...
      >
        ...
        >
          <div className="max-w-4xl w-full">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-3 sm:mb-4 md:mb-6 backdrop-blur-lg bg-black/30 p-4 sm:p-5 md:p-6 rounded-xl border border-white/10">Our Solution – BugChase</h1>
            <div className="text-sm sm:text-base md:text-lg text-gray-300 space-y-2 sm:space-y-3 md:space-y-4 backdrop-blur-lg bg-black/30 p-4 sm:p-5 md:p-6 rounded-xl border border-white/10">
              ...
              <p>BugChase serves as a secure bridge between organizations and ethical hackers, allowing approved vulnerability testing, structured reporting, and legal payouts — all under the framework of the PECA Act.</p>
              ...
              <table className="w-full text-left border-collapse min-w-[800px]">
                ...
                <tbody className="text-gray-300">
                  ...
                  <tr className="border-b border-gray-700 bg-blue-900/20">
                    <td className="p-2 sm:p-3 md:p-4 font-semibold text-blue-400 text-xs sm:text-sm md:text-base whitespace-nowrap">BugChase (Proposed)</td>
        ...
        >
          <div className="max-w-4xl w-full">
            ...
            <div className="text-sm sm:text-base md:text-lg text-gray-300 space-y-3 sm:space-y-4 md:space-y-6 backdrop-blur-lg bg-black/30 p-4 sm:p-5 md:p-6 rounded-xl border border-white/10">
              <p>BugChase operates through a streamlined process that ensures clarity, legality, and security for all participants:</p>
        ...
        >
          <div className="max-w-4xl w-full text-center">
            ...
            <div className="text-sm sm:text-base md:text-lg text-gray-300 space-y-3 sm:space-y-4 md:space-y-6 backdrop-blur-lg bg-black/30 p-4 sm:p-5 md:p-6 rounded-xl border border-white/10">
              ...
              <p>Our proposed BugChase provides a localized, secure, and legally compliant environment where organizations can collaborate with researchers to strengthen their defenses.</p>
